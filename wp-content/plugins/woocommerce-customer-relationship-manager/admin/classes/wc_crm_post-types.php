...
class WC_CRM_Post_Types {
  ...
  public function add_wc_crm_accounts_column( $columns ) {
    unset($columns['date']);
    $columns['title']     = __('Account Name', 'wc_customer_relationship_manager');
    $columns['owner']     = __('Account Owner', 'wc_customer_relationship_manager');
    $columns['type']      = __('Account Type', 'wc_customer_relationship_manager');
    $columns['ownership'] = __('Ownership', 'wc_customer_relationship_manager');
    $columns['industry']  = __('Industry', 'wc_customer_relationship_manager');
