...
class WC_Crm_Phone_Call {
			...
			<table class="wp-list-table form-table fixed phone_call">
				...
				<tr>
					...
					<td>
						...
						<a href="?page=wc-customer-relationship-manager&order_list=order&order_id=<?php echo $order_id; ?>" class="button glass tips" id="view_info" data-tip="<?php _e('Find', 'wc_customer_relationship_manager'); ?>"></a>
	...
	<div id="place_new_call_popup" class="overlay_media_popup">
	    <div class="media-modal wp-core-ui">
	    	<a href="#" class="media-modal-close"><span class="media-modal-icon"><span class="screen-reader-text"><?php _e('Close', 'wc_customer_relationship_manager'); ?></span></span></a>
	    	<div class="media-modal-content">
	    		<div class="media-frame mode-select wp-core-ui hide-menu">
	    			<div class="media-frame-title"><h1><?php _e('Select Related Order', 'wc_customer_relationship_manager'); ?><span class="dashicons dashicons-arrow-down"></span></h1></div>
