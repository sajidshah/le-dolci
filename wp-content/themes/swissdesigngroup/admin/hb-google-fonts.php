...
if ( ! function_exists( 'hb_recognized_google_fonts' ) ) {
  
  	function hb_recognized_google_fonts( $field_id = '' ) {
		...
		return apply_filters( 'hb_recognized_google_fonts' , $google_fonts , $field_id );
