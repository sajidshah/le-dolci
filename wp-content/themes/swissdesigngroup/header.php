...
<?php 
/**
 * Hooked your actions and filter which goes before page and you dont want its content get refrush when user surf to the site.
 */
do_action('hb_before_page_content'); ?>
			...
			<div class="row">
				...
				<div class="col-xs-6 text-right">
					<div class="site-navigations">
						...
						<div id="hb-fancy-menu">
							<div id="hb-fancy-menu-head" class="clearfix">
								<span id="hb-fancy-menu-title"><?php _e('Navigation', HB_DOMAIN_TXT); ?></span>
								<span id="hb-toggle-menu">
									<span class="nav-top"></span>
									<span class="nav-mid"></span>
									<span class="nav-btm"></span>
								</span>
							</div>
							<div id="hb-fancy-menu-body">
								<nav id="top-navigation" class="site-navigation" role="navigation">
									<?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_class' => 'nav-menu', 'depth' => 1 ) ); ?>
								</nav>
								<?php if ( has_nav_menu( 'secondary' ) ) : ?>
								<nav id="btm-navigation" class="site-navigation" role="navigation">
						...
						<?php endif; ?>
						<?php do_action('hb_after_menu_toggle'); ?>
					</div>
				</div>
			</div>
		</div>
	...
	<?php
	/**
	 * Hooked your actions and filter which goes after header.
	 */
	do_action('hb_after_header'); ?>
