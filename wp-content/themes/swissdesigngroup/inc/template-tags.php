...
function SDG_site_logo_func( $option = '' ) {
	...
	$alt_logo 	= ot_get_option( 'alt_' . $option );
	$alt_logo 	= $alt_logo ? $alt_logo : $logo;

	echo ( $logo ) 

		?

		'<img class="site-logo" src="'.esc_url($logo).'" alt="'.esc_attr($site_title).'">' .
		'<img class="site-alt-logo" src="'.esc_url($alt_logo).'" alt="'.esc_attr($site_title).'">'
